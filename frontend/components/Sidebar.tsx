...
import { X, ChevronRight } from "lucide-react"; // 닫기 버튼 아이콘
import { Restaurant } from "@/app/utils/types";  // Assuming you have a proper type for Restaurant

interface HistoryEntry {
  keyword: string;
  results: Restaurant[];  // ✅ Use the correct type
}
...
interface SidebarProps {
  ...
  onRestaurantClick: (restaurant: Restaurant) => void;  // ✅ Use Restaurant type
