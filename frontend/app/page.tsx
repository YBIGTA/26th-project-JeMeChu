...
const Home = () => {
  ...
  const handleSearch = async () => {
    try {
      ...
      const parsedResults = responseData?.map((restaurant: Restaurant) =>
  ...
  return (
  <div className="w-screen h-screen flex flex-col items-center justify-between bg-[#E7E7E7] bg-opacity-50 px-6 py-10">      {/* 상단 텍스트 */}
